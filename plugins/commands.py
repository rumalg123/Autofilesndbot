...
async def check_user_access(client, message, user_id, *, increment: bool = False):
    ...
    if info.DISABLE_PREMIUM_FOR_USERS:
        return True, "Premium access disabled: Unlimited"
...
async def plans_command(client: Client, message: Message):
    if info.DISABLE_PREMIUM_FOR_USERS:
        await message.reply_text("Premium features are currently disabled. All users have unlimited access.")
        return
