...
AUTO_DELETE_MESSAGE_TIME = int(environ.get('AUTO_DELETE_MESSAGE_TIME', '600')) # Default to 10 minutes (600 seconds)
...
LOG_STR += f"Auto-delete message time is set to {AUTO_DELETE_MESSAGE_TIME} seconds.\n"
...
def get_config_data_from_env():
    ...
    config_data = {
        ...
        "AUTO_DELETE_MESSAGE_TIME": AUTO_DELETE_MESSAGE_TIME,
    }
    return config_data
...
AUTO_DELETE_MESSAGE_TIME = CONFIG.get("AUTO_DELETE_MESSAGE_TIME", AUTO_DELETE_MESSAGE_TIME)
